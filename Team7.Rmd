...
information) have some same columns such as directors.
...
Convert Release Date from numeric to visible format by using as.Date.
...
Kofic (Korean Film Council) but didn't be shown to the audience.
