...
we decided to drop columns other than Name, Release Date, Nationality, Total Screens, Box Office, Audience, Genre, Rate, Artistic
```{r}
...
ggplot(Top100_ByNation, 
       aes(x=Nationality, y= Mean_Box_Office, 
           label =round(Mean_Box_Office/1000000000,2)))+
  geom_bar(stat='identity', fill = 'orchid2') +
  labs(title = "Average Box Office of Top 100 Movies by Nationality",
          subtitle="KRW Billion") +
  scale_x_discrete(breaks=c('미국',"한국"), labels = c('USA',"Korea"))+
  geom_text(size = 5, position = position_stack(vjust = 0.5)) +
