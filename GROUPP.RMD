...
```{r}
ggplot(df_edit_col_ggp1[rev(order(ggyear1)),],aes(Month1,BOX_total1, fill = ggyear1)) +
  geom_bar(stat="identity",position="dodge",color="black") +
  ggtitle('Box Office in Q1 (2008–2021)') +
  xlab("Month") +
  ylab("Box Office") +
  labs(fill = "Year")

ggplot(df_edit_col_ggp2[rev(order(ggyear2)),],aes(Month2,BOX_total2, fill = ggyear2)) +
  geom_bar(stat="identity",position="dodge",color="black")+
  ggtitle('Box Office in Q2 (2008–2021.4)') +
  xlab("Month") +
  ylab("Box Office") +
  labs(fill = "Year")

ggplot(df_edit_col_ggp3[rev(order(ggyear3)),],aes(Month3,BOX_total3, fill = ggyear3)) + 
  geom_bar(stat="identity",position="dodge",color="black")+
  ggtitle('Box Office in Q3 (2008–2020)') +
  xlab("Month") +
  ylab("Box Office") +
  labs(fill = "Year")

ggplot(df_edit_col_ggp4[rev(order(ggyear4)),],aes(Month4,BOX_total4, fill = ggyear4)) + 
  geom_bar(stat="identity",position="dodge",color="black")+
  ggtitle('Box Office in Q4 (2008–2020)') +
  xlab("Month") +
  ylab("Box Office") +
  labs(fill = "Year")
```
