...
```{r}
ggplot(subset(genres, mean_name != "zero" & mean_name != "etc"), aes(x=name, y=genre_mean, fill = genre_mean)) +
...
```{r}
ggplot(subset(genres, median_name != "zero" & median_name != "etc"), aes(x=name, y=genre_median, fill = genre_median))+
  geom_bar(stat="identity", position="dodge") +
  coord_flip() +
  scale_y_continuous(trans = "log") +
  xlab("Genre") +
